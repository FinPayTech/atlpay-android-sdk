...
import com.atlpay.android.CardScanningFragment;
import com.atlpay.android.OnCardFormFieldFocusedListener;
import com.atlpay.android.OnCardFormSubmitListener;
import com.atlpay.android.OnCardFormValidListener;
import com.atlpay.android.R;
import com.atlpay.android.utils.CardType;
import com.atlpay.android.utils.ViewUtils;
import com.atlpay.android.view.CardEditText.OnCardTypeChangedListener;
...
public class CardForm extends LinearLayout implements OnCardTypeChangedListener, OnFocusChangeListener, OnClickListener,
    ...
    private NameOnCardEditText mNameOnCard;
    ...
    private boolean mNameOnCardRequired;
    ...
    private void init() {
        ...
        mNameOnCard         = findViewById(R.id.bt_card_form_nameoncard);
    ...
    /**
     * @param required {@code true} to show and require name on card, {@code false} otherwise. Defaults to {@code false}.
     * @return {@link CardForm} for method chaining
     */
    public CardForm nameOnCardRequired(boolean required) {
        mNameOnCardRequired = required;
        return this;
    }
    ...
    public void setup(Activity activity) {
        ...
        setFieldVisibility(mNameOnCard, mNameOnCardRequired);
    ...
    /**
     * Set the listener to receive a callback when the {@link com.atlpay.android.utils.CardType} changes.
     *
     * @param listener to receive the callback
     */
    ...
    public void setEnabled(boolean enabled) {
        ...
        mNameOnCard.setEnabled(enabled);
    }
    ...
    public boolean isValid() {
        ...
        if (mNameOnCardRequired) {
            valid = valid && mNameOnCard.isValid();
        }
    ...
    /**
     * @return {@link NameOnCardEditText} view in the card form
     */
    public NameOnCardEditText getNameOnCardEditText() {
        return mNameOnCard;
    }
    ...
    /**
     * Set visual indicator on name on card to indicate error
     *
     * @param errorMessage the error message to display
     */
    public void setNameOnCardError(String errorMessage) {
        if (mNameOnCardRequired) {
            mNameOnCard.setError(errorMessage);
            if (!mCardNumber.isFocused() && !mExpiration.isFocused() && !mCvv.isFocused()) {
                requestEditTextFocus(mNameOnCard);
            }
        }
    }
    ...
    public String getName() {
        return mNameOnCard.getText().toString();
    }
